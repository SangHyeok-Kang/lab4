...
int main(int argc, char *argv[]){
	...
	gtk_tree_store_set(store, &parent_iter, COLUMN_TITLE, "다시 부르기", COLUMN_ARTIST, "주호", COLUMN_CATALOGUE, "A221210", -1);
	gtk_tree_store_append (store, &child_iter, &parent_iter);
	gtk_tree_store_set (store, &child_iter, COLUMN_TITLE, "잘가요", -1);
